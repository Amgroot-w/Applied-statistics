...
# %% 线性回归
# beta_h1, y_h1, p_val1 = LR(data_x, data_y, reg='L2', lamda=0)  # 线性回归（无正则化）

# beta_h2, y_h2, p_val2 = LR(data_x, data_y, reg='L2', lamda=1)  # 线性回归（L2正则化）

beta_h3, y_h3 = LR(data_x, data_y, reg='L1', lamda=0.1)  # 线性回归（L1正则化）
